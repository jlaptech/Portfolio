      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="shrink-0 flex flex-col items-center">
          <div className="relative w-48 h-48 md:w-56 md:h-56">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan-400 to-blue-500 blur-xl opacity-30" />
            <div className="relative w-full h-full rounded-full border-2 border-cyan-400/40 overflow-hidden shadow-2xl">
              <img
                src="/profile.jpg"
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 mb-8">
            <a
              href="#experience"
              className="px-8 py-3 bg-cyan-500 hover:bg-cyan-400 text-gray-950 font-semibold rounded-lg transition-colors duration-200"
            >
              View My Work
            </a>
            <a
              href="#contact"
              className="px-8 py-3 border border-gray-700 hover:border-cyan-400 hover:text-cyan-400 rounded-lg transition-colors duration-200"
            >
              Get In Touch
            </a>
          </div>
          ...
          <div className="flex justify-center md:justify-start gap-4 mb-10">
            <a
              href="https://www.linkedin.com/in/jlaperalta/"
              target="_blank"
            ...
            <a
              href="https://github.com/jlaptech"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-700 hover:border-cyan-400 hover:text-cyan-400 text-gray-400 text-sm transition-colors duration-200"
            >
